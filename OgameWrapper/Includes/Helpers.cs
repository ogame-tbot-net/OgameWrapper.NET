...
namespace OgameWrapper.Includes
{
    public static class Helpers
    {
		...
		public static int CalcShipCapacity(Buildables buildable, int hyperspaceTech, PlayerClasses playerClass, int probeCargo = 0)
		{
			int baseCargo;
			...
			switch (buildable)
			{
				case Buildables.SmallCargo:
					baseCargo = 5000;
					if (playerClass == PlayerClasses.Collector)
						bonus += 25;
					break;
				...
				case Buildables.Recycler:
					baseCargo = 20000;
					if (playerClass == PlayerClasses.General)
						bonus += 25;
					break;
		...
		public static long CalcFleetCapacity(Ships fleet, int hyperspaceTech, PlayerClasses playerClass, int probeCargo = 0)
		{
			long total = 0;
		...
		public static int CalcShipSpeed(Buildables buildable, Researches researches, PlayerClasses playerClass)
		{
			return CalcShipSpeed(buildable, researches.CombustionDrive, researches.ImpulseDrive, researches.HyperspaceDrive, playerClass);
		}

		public static int CalcShipSpeed(Buildables buildable, int combustionDrive, int impulseDrive, int hyperspaceDrive, PlayerClasses playerClass)
		{
			int baseSpeed;
		...
		public static int CalcSlowestSpeed(Ships fleet, Researches researches, PlayerClasses playerClass)
		{
			return CalcSlowestSpeed(fleet, researches.CombustionDrive, researches.ImpulseDrive, researches.HyperspaceDrive, playerClass);
		}

		public static int CalcSlowestSpeed(Ships fleet, int combustionDrive, int impulseDrive, int hyperspaceDrive, PlayerClasses playerClass)
		{
		...
		public static int CalcFleetSpeed(Ships fleet, Researches researches, PlayerClasses playerClass)
		{
			return CalcFleetSpeed(fleet, researches.CombustionDrive, researches.ImpulseDrive, researches.HyperspaceDrive, playerClass);
		}

		public static int CalcFleetSpeed(Ships fleet, int combustionDrive, int impulseDrive, int hyperspaceDrive, PlayerClasses playerClass)
		{
			int minSpeed = 0;
			foreach (PropertyInfo prop in fleet.GetType().GetProperties())
			{
		...
		public static int CalcShipConsumption(Buildables buildable, Researches researches, ServerData serverData, PlayerClasses playerClass)
		{
		...
		public static int CalcShipConsumption(Buildables buildable, int impulseDrive, int hyperspaceDrive, double deuteriumSaveFactor, PlayerClasses playerClass)
		{
			int baseConsumption;
			switch (buildable)
			{
		...
		public static long CalcFlightTime(Coordinate origin, Coordinate destination, Ships ships, Missions mission, decimal speed, Researches researches, ServerData serverData, PlayerClasses playerClass)
		{
		...
		public static long CalcFlightTime(Coordinate origin, Coordinate destination, Ships ships, decimal speed, int combustionDrive, int impulseDrive, int hyperspaceDrive, int numberOfGalaxies, int numberOfSystems, bool donutGalaxies, bool donutSystems, int fleetSpeed, PlayerClasses playerClass)
		{
		...
		public static long CalcFuelConsumption(Coordinate origin, Coordinate destination, Ships ships, Missions mission, long flightTime, Researches researches, ServerData serverData, PlayerClasses playerClass)
		{
			var fleetSpeed = mission switch
			{
		...
		public static long CalcFuelConsumption(Coordinate origin, Coordinate destination, Ships ships, long flightTime, int combustionDrive, int impulseDrive, int hyperspaceDrive, int numberOfGalaxies, int numberOfSystems, bool donutGalaxies, bool donutSystems, int fleetSpeed, float deuteriumSaveFactor, PlayerClasses playerClass)
		{
			int distance = CalcDistance(origin, destination, numberOfGalaxies, numberOfSystems, donutGalaxies, donutSystems);
		...
		public static FleetPrediction CalcFleetPrediction(Coordinate origin, Coordinate destination, Ships ships, Missions mission, decimal speed, Researches researches, ServerData serverData, PlayerClasses playerClass)
		{
		...
		public static FleetPrediction CalcFleetPrediction(Celestial origin, Coordinate destination, Ships ships, Missions mission, decimal speed, Researches researches, ServerData serverData, PlayerClasses playerClass)
		{
		...
		public static long CalcEnergyProduction(Buildables buildable, int level, int energyTechnology = 0, float ratio = 1, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasEngineer = false, bool hasStaff = false)
		{
			long prod = 0;
		...
		public static long CalcEnergyProduction(Buildables buildable, int level, Researches researches, float ratio = 1, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasEngineer = false, bool hasStaff = false)
		{
			return CalcEnergyProduction(buildable, level, researches.EnergyTechnology, ratio, playerClass, hasEngineer, hasStaff);
		}

		public static long CalcMetalProduction(int level, int position, int speedFactor, float ratio = 1, int plasma = 0, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false)
		{
		...
		public static long CalcMetalProduction(Buildings buildings, int position, int speedFactor, float ratio = 1, Researches researches = null, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false)
		{
			if (researches == null)
		...
		public static long CalcMetalProduction(Planet planet, int speedFactor, float ratio = 1, Researches researches = null, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false)
		{
			if (researches == null)
				researches = new Researches() { PlasmaTechnology = 0 };
		...
		public static long CalcCrystalProduction(int level, int position, int speedFactor, float ratio = 1, int plasma = 0, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false)
		{
			int baseProd = position switch
			{
		...
		public static long CalcCrystalProduction(Buildings buildings, int position, int speedFactor, float ratio = 1, Researches researches = null, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false)
		{
			if (researches == null)
				researches = new Researches() { PlasmaTechnology = 0 };
		...
		public static long CalcCrystalProduction(Planet planet, int speedFactor, float ratio = 1, Researches researches = null, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false)
		{
			if (researches == null)
				researches = new Researches() { PlasmaTechnology = 0 };
		...
		public static long CalcDeuteriumProduction(int level, float temp, int speedFactor, float ratio = 1, int plasma = 0, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false)
		{
			if (level == 0)
				return 0;
		...
		public static long CalcDeuteriumProduction(Buildings buildings, Temperature temp, int speedFactor, float ratio = 1, Researches researches = null, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false)
		{
			if (researches == null)
				researches = new Researches() { PlasmaTechnology = 0 };
		...
		public static long CalcDeuteriumProduction(Planet planet, int speedFactor, float ratio = 1, Researches researches = null, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false)
		{
			if (researches == null)
				researches = new Researches() { PlasmaTechnology = 0 };
		...
		public static Resources CalcPlanetHourlyProduction(Planet planet, int speedFactor, float ratio = 1, Researches researches = null, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false)
		{
		...
		public static long CalcProductionTime(Buildables buildable, int level, int speed = 1, Facilities facilities = null, int cumulativeLabLevel = 1, bool isDiscoverer = false, bool hasTechnocrat = false)
		{
			...
			switch (buildable)
			{
				...
				case Buildables.SensorPhalanx:
				case Buildables.JumpGate:
					output = (double)structuralIntegrity / ((double)2500 * ((double)1 + (double)facilities.RoboticsFactory) * (double)speed * (double)Math.Pow(2, facilities.NaniteFactory ?? 0));
					break;
				...
				case Buildables.Reaper:
				case Buildables.Pathfinder:
					output = (double)structuralIntegrity / ((double)2500 * ((double)1 + (double)facilities.Shipyard) * (double)speed * (double)Math.Pow(2, facilities.NaniteFactory ?? 0));
					break;
				...
				case Buildables.GravitonTechnology:
					...
					{
						cumulativeLabLevel = facilities.ResearchLab ?? 0;
					}
		...
		public static int GetNextLevel(Celestial planet, Buildables buildable, bool isCollector = false, bool hasEngineer = false, bool hasFullStaff = false)
		{
			...
			if (buildable == Buildables.SolarSatellite)
				if (planet is Planet)
					output = CalcNeededSolarSatellites(planet as Planet, (long)Math.Abs((double)planet.Resources.Energy), isCollector, hasEngineer, hasFullStaff);
		...
		public static bool ShouldBuildMetalStorage(Planet planet, int maxLevel, int speedFactor, int hours = 12, float ratio = 1, Researches researches = null, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false, bool forceIfFull = false)
		{
		...
		public static bool ShouldBuildCrystalStorage(Planet planet, int maxLevel, int speedFactor, int hours = 12, float ratio = 1, Researches researches = null, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false, bool forceIfFull = false)
		{
		...
		public static bool ShouldBuildDeuteriumTank(Planet planet, int maxLevel, int speedFactor, int hours = 12, float ratio = 1, Researches researches = null, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false, bool forceIfFull = false)
		{
		...
		public static int CalcNeededSolarSatellites(Planet planet, long requiredEnergy = 0, bool isCollector = false, bool hasEngineer = false, bool hasFullStaff = false)
		{
			if (requiredEnergy == 0)
			{
				if (planet.Resources.Energy != null &&planet.Resources.Energy  > 0)
					return 0;
				return (int)Math.Round((float)(Math.Abs((double)planet.Resources.Energy) / GetSolarSatelliteOutput(planet, isCollector, hasEngineer, hasFullStaff)), MidpointRounding.ToPositiveInfinity);
			}
			else
		...
		public static Buildables GetNextMineToBuild(Planet planet, Researches researches = null, int speedFactor = 1, int maxMetalMine = 100, int maxCrystalMine = 100, int maxDeuteriumSynthetizer = 100, float ratio = 1, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false, bool optimizeForStart = true, float maxDaysOfInvestmentReturn = 36500)
		{
			if (optimizeForStart && (planet.Buildings.MetalMine < 10 || planet.Buildings.CrystalMine < 7 || planet.Buildings.DeuteriumSynthesizer < 5))
			{
		...
		public static float CalcROI(Planet planet, Buildables buildable, Researches researches = null, int speedFactor = 1, float ratio = 1, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false)
		{
			float currentProd;
			float nextLevelProd;
			float cost;
		...
		public static float CalcDaysOfInvestmentReturn(Planet planet, Buildables buildable, Researches researches = null, int speedFactor = 1, float ratio = 1, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false)
		{
		...
		public static float CalcNextDaysOfInvestmentReturn(Planet planet, Researches researches = null, int speedFactor = 1, float ratio = 1, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false)
		{
		...
		public static float CalcNextPlasmaTechDOIR(List<Planet> planets, Researches researches, int speedFactor = 1, float ratio = 1, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false)
		{
		...
		public static float CalcNextAstroDOIR(List<Planet> planets, Researches researches, int speedFactor = 1, float ratio = 1, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false)
		{
        ...
        public static Buildables GetNextMineToBuild(List<Celestial> celestials, Researches researches, Buildings maxBuildings, Facilities maxFacilities, PlayerClasses playerClass, Staff staff, ServerData serverData, AutoMinerSettings settings, float ratio = 1)
        {
            var dic = new Dictionary<Planet, float>();
		...
		public static Buildables GetNextBuildingToBuild(Planet planet, Researches researches, Buildings maxBuildings, Facilities maxFacilities, PlayerClasses playerClass, Staff staff, ServerData serverData, AutoMinerSettings settings, float ratio = 1)
		{
			Buildables buildableToBuild = Buildables.Null;
			if (ShouldBuildTerraformer(planet, researches, maxFacilities.Terraformer ?? 0))
		...
		public static Buildables GetNextDepositToBuild(Planet planet, Researches researches, Buildings maxBuildings, PlayerClasses playerClass, Staff staff, ServerData serverData, AutoMinerSettings settings, float ratio = 1)
		{
		...
		public static Buildables GetNextFacilityToBuild(Planet planet, Researches researches, Buildings maxBuildings, Facilities maxFacilities, PlayerClasses playerClass, Staff staff, ServerData serverData, AutoMinerSettings settings, float ratio = 1, bool force = false)
		{
			...
			if (facilityToBuild == Buildables.Null && ShouldBuildResearchLab(planet, maxFacilities.ResearchLab ?? 0, researches, serverData.Speed, serverData.ResearchDurationDivisor, maxBuildings.MetalMine, maxBuildings.CrystalMine, maxBuildings.DeuteriumSynthesizer, 1, playerClass, staff.Geologist, staff.IsFull, settings.OptimizeForStart, settings.MaxDaysOfInvestmentReturn, force) && planet.Constructions.ResearchID == 0)
				facilityToBuild = Buildables.ResearchLab;
			if (facilityToBuild == Buildables.Null && ShouldBuildMissileSilo(planet, maxFacilities.MissileSilo ?? 0, researches, serverData.Speed, maxBuildings.MetalMine, maxBuildings.CrystalMine, maxBuildings.DeuteriumSynthesizer, 1, playerClass, staff.Geologist, staff.IsFull, settings.OptimizeForStart, settings.MaxDaysOfInvestmentReturn, force))
				facilityToBuild = Buildables.MissileSilo;

			return facilityToBuild;
		}

		public static Buildables GetNextMineToBuild(Planet planet, Researches researches, Buildings maxBuildings, Facilities maxFacilities, PlayerClasses playerClass, Staff staff, ServerData serverData, AutoMinerSettings settings, float ratio = 1)
		{
		...
		{
			return GetNextLunarFacilityToBuild(moon, researches, maxLunarFacilities.LunarBase ?? 0, maxLunarFacilities.RoboticsFactory, maxLunarFacilities.SensorPhalanx ?? 0, maxLunarFacilities.JumpGate ?? 0, maxLunarFacilities.Shipyard);
		}
		...
		public static bool ShouldBuildShipyard(Celestial celestial, int maxLevel = 12, Researches researches = null, int speedFactor = 1, int maxMetalMine = 100, int maxCrystalMine = 100, int maxDeuteriumSynthetizer = 100, float ratio = 1, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false, bool optimizeForStart = true, float maxDaysOfInvestmentReturn = 36500, bool force = false)
		{
			if (celestial is Planet)
			{
				var nextMine = GetNextMineToBuild(celestial as Planet, researches, speedFactor, maxMetalMine, maxCrystalMine, maxDeuteriumSynthetizer, ratio, playerClass, hasGeologist, hasStaff, optimizeForStart, maxDaysOfInvestmentReturn);
		...
		public static bool ShouldBuildResearchLab(Planet celestial, int maxLevel = 12, Researches researches = null, int speedFactor = 1, float researchDurationDivisor = 2, int maxMetalMine = 100, int maxCrystalMine = 100, int maxDeuteriumSynthetizer = 100, float ratio = 1, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false, bool optimizeForStart = true, float maxDaysOfInvestmentReturn = 36500, bool force = false)
		{
		...
		public static bool ShouldBuildMissileSilo(Planet celestial, int maxLevel = 6, Researches researches = null, int speedFactor = 1, int maxMetalMine = 100, int maxCrystalMine = 100, int maxDeuteriumSynthetizer = 100, float ratio = 1, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasGeologist = false, bool hasStaff = false, bool optimizeForStart = true, float maxDaysOfInvestmentReturn = 36500, bool force = false)
		{
			var nextMine = GetNextMineToBuild(celestial, researches, speedFactor, maxMetalMine, maxCrystalMine, maxDeuteriumSynthetizer, ratio, playerClass, hasGeologist, hasStaff, optimizeForStart, maxDaysOfInvestmentReturn);
			var nextMineLevel = GetNextLevel(celestial, nextMine);
			var nextMinePrice = CalcPrice(nextMine, nextMineLevel);
		...
		public static bool ShouldResearchEnergyTech(List<Planet> planets, int energyTech, int maxEnergyTech = 25, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasEngineer = false, bool hasStaff = false)
		{
		...
		public static bool ShouldResearchEnergyTech(List<Planet> planets, Researches researches, int maxEnergyTech = 25, PlayerClasses playerClass = PlayerClasses.NoClass, bool hasEngineer = false, bool hasStaff = false)
		{
		...
		public static int CalcMaxCrawlers(Planet planet, PlayerClasses userClass)
		{
